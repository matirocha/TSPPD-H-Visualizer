...
/**
 * Calcula las posiciones de nodos en un layout circular (como en Pagina Web 5).
 * El depósito (nodo 0) se posiciona en el centro.
 * Los clientes se distribuyen uniformemente en un círculo alrededor.
 */
...
/**
 * Calcula el punto de control/medio de un arco curvo entre dos puntos.
 */
export function arcMidpoint(from: Point, to: Point, curvature: number = 0.2): Point {
...
/**
 * Genera el path SVG de un arco curvado cuadrático entre dos puntos.
 */
export function curvedArcPath(from: Point, to: Point, curvature: number = 0.2): string {
