...
# TSPPD-H Visualizador - Pagina Web 12 (macOS)
echo -ne "\033]0;TSPPD-H Visualizador - Pagina Web 12 (Opus 5.5)\007"
...
# Cambiar al directorio del script y luego a Pagina Web 12
DIR="$(cd "$(dirname "$0")" && pwd)"
cd "$DIR/Pagina Web 12 (Opus 5.5)" || {
    echo "[ERROR] No se pudo acceder al directorio: $DIR/Pagina Web 12 (Opus 5.5)"
...
echo ""
echo "===================================================="
echo "  TSPPD-H Visualizador - Pagina Web 12 (Opus 5.5)"
echo "  Simulación unidad por unidad + comparativa de políticas"
echo "===================================================="
echo ""
